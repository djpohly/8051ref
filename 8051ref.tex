...
\noindent
\texttt{PSW}:
\begin{tabularx}{2in}{@{}C@{}C@{}C@{}C@{}C@{}C@{}C@{}C@{}}
   7 & 6 & 5 & 4 & 3 & 2 & 1 & 0 \\
   \texttt{C} &
   \texttt{A} &
   \texttt{F0} &
...
\begin{tabular}[t]{l>{\normalfont}lcccc>{\normalfont}cc@{\,\,}c@{\,\,}c@{\,\,}c>{\normalfont}c}
  ...
  & Operands & \normalfont \#\fn1 & \normalfont M\fn1 & \normalfont @Ri & \normalfont Rn &
    Len & \multicolumn{4}{c}{\normalfont Fl} & Cyc \\
  \midrule
  INC  & op             &04\fn2& 05 & 06+i & 08+n & 1/2 & & & &P\fn2& 1 \\
  DEC  & op             &14\fn2& 15 & 16+i & 18+n & 1/2 & & & &P\fn2& 1 \\
  ...
  MOV  & op, \#imm      &74\fn2&    & 76+i & 78+n & 2/3 & & & &P\fn2& 1 \\
